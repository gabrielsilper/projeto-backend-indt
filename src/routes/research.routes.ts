...
researcherRouter.post("/", validateBody(createResearcherSchema), (req, res) =>
	researcherController.create(req, res),
);
researcherRouter.get("/:id", (req, res) =>
	researcherController.getById(req, res),
);
researcherRouter.put("/:id", (req, res) =>
	researcherController.update(req, res),
);
researcherRouter.delete("/:id", (req, res) =>
	researcherController.delete(req, res),
);
